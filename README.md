...
1. Sistem de gestionare a resurselor:
     ...
     - Gestionarea datelor: Sistem complet de Save/Load a progresului, menținând inventarul și statisticile intacte între sesiuni de joc
